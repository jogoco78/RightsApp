...
public class RVAParticlesCluster extends RecyclerView.Adapter<RVAParticlesCluster.ViewHolder> {
    ...
    public RVAParticlesCluster(Context context, ArrayList<TagModel> dataSet){
